...
export async function POST(request: NextRequest) {
  ...
  const { data, error } = await admin
    ...
    .insert({
      ...
      default_commission: body.default_commission ?? null,
      customer_price: body.customer_price ?? null,
      device_cost: body.device_cost ?? null,
      cost_5plus: body.cost_5plus ?? null,
      cost_10plus: body.cost_10plus ?? null,
      cost_20plus: body.cost_20plus ?? null,
      cost_30plus: body.cost_30plus ?? null,
      cost_50plus: body.cost_50plus ?? null,
      cost_100plus: body.cost_100plus ?? null,
